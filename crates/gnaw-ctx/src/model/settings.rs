        ...
        match (key, action) {
            ...
            (SettingKey::SortMethod, SettingAction::Cycle) => {
                session.config.sort_method = Some(match session.config.sort_method {
                    Some(gnaw_core::sort::FileSortMethod::NameAsc) => {
                        gnaw_core::sort::FileSortMethod::NameDesc
                    }
                    Some(gnaw_core::sort::FileSortMethod::NameDesc) => {
                        gnaw_core::sort::FileSortMethod::DateAsc
                    }
                    Some(gnaw_core::sort::FileSortMethod::DateAsc) => {
                        gnaw_core::sort::FileSortMethod::DateDesc
                    }
                    Some(gnaw_core::sort::FileSortMethod::DateDesc) | None => {
                        gnaw_core::sort::FileSortMethod::NameAsc
                    }
                });
                "Sort Method"
            }
            (SettingKey::TokenizerType, SettingAction::Cycle) => {
                session.config.encoding = match session.config.encoding {
                    gnaw_core::tokenizer::TokenizerType::Cl100kBase => {
                        gnaw_core::tokenizer::TokenizerType::O200kBase
                    }
                    gnaw_core::tokenizer::TokenizerType::O200kBase => {
                        gnaw_core::tokenizer::TokenizerType::P50kBase
                    }
                    gnaw_core::tokenizer::TokenizerType::P50kBase => {
                        gnaw_core::tokenizer::TokenizerType::P50kEdit
                    }
                    gnaw_core::tokenizer::TokenizerType::P50kEdit => {
                        gnaw_core::tokenizer::TokenizerType::R50kBase
                    }
                    gnaw_core::tokenizer::TokenizerType::R50kBase => {
                        gnaw_core::tokenizer::TokenizerType::Cl100kBase
                    }
